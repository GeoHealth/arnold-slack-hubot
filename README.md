...
You can start Arnold locally by running:
...
Then you can interact with Arnold by typing `Arnold help`.

    Arnold> Arnold help
    Arnold animate me <query> - The same thing as `image me`, except adds [snip]
    Arnold help - Displays all of the help commands that Arnold knows about.
    ...
